...
const Main = (props) => {
  // ** toggles the create post functionality
  const [showModal, setShowModal] = useState("close");

  // ** updates the articles on the page
  useEffect(() => {
    props.getArticles();
  }, []);

  // ** handles click of post funcitonality
  const handleClick = (e) => {
    e.preventDefault();
          ...
          */}
          <ShareBox> 
            <div>
              ...
              disabled={props.loading ? true : false } >Start a post
              </button>
            </div>
          ...
          <Content>
            ...
            <Article key = {key} >
              ...
              <SharedImg>
                <a>
                  {
                  !article.shareImg && article.video ? <ReactPlayer width={'100%'}
                  url={article.video}
                  />
                  :
